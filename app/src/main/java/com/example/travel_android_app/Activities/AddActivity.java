...
public class AddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mode.equals("book")){
            titleView.setText("Add a Hotel to Library");
            mainText.setHint("Hotel Title");
            subText.setHint("Hotel Author");
            subTexttwo.setHint("Hotel Description");
            ...
            titleView.setText("Update a Hotel Record");
    ...
    private void addBookRecord(String title, String auth, String desc) {
        ...
        if (!title.isEmpty() || !auth.isEmpty() || !desc.isEmpty()){
            ...
            subText.setText("");
            subTexttwo.setText("");
            Toast.makeText(AddActivity.this, "Hotel added!", Toast.LENGTH_LONG).show();
